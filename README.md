...
**Cevap:** x = -1.23t^2 + 1.7t + 9,42E-04. a'nın değerinin negatif olmasının nedeni hızın gittikçe azalması olabilir.
...
**Cevap:** b ve c terimleri değişirdi.
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1dehN7hKZalBakympiwpIKRv3joR4X62ZTcHtUoyz3oE/edit#gid=0) link veriniz.
